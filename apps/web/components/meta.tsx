		...
		<Head>
			...
			<title>
				{`${
					titleTag
						? titleTag
						: "Kurt Lekanger - tekst, kommunikasjon, innholdsprodusent og utvikler"
				}`}
			</title>
			...
			<meta
				...
				content={`${
					description
						? description
						: "Tekstforfatter, innholdsprodusent, oversetter og utvikler. Javascript, TypeScript, React, Next.js."
				}`}
				key="ogdesc"
			/>
